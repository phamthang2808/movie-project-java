...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> upgradeToVip(@RequestBody Map<String, Object> request) {
        ...
        ApiResponse<Map<String, Object>> response = ApiResponse.success("Nâng cấp VIP thành công!", data);
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> getTransactionHistory(
        ...
        ApiResponse<Map<String, Object>> response = ApiResponse.success("Lấy lịch sử giao dịch thành công", data);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> createBankTransferTransaction(
        ...
        ApiResponse<Map<String, Object>> response = ApiResponse.success("Tạo giao dịch chuyển khoản thành công", data);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> verifyBankTransfer(
        ...
        ApiResponse<Map<String, Object>> response = ApiResponse.success("Xác thực giao dịch chuyển khoản thành công", data);
        return ResponseEntity.ok(response);
    }
