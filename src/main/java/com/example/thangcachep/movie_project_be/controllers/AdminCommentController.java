...
public class AdminCommentController {
    ...
    public ResponseEntity<ApiResponse<CommentResponse>> approveComment(@PathVariable Long id) {
        ...
        String message = localizationUtils.getLocalizedMessage(MessageKeys.COMMENT_APPROVE_SUCCESS);
        ApiResponse<CommentResponse> response = ApiResponse.success(message, comment);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<CommentResponse>> rejectComment(@PathVariable Long id) {
        ...
        String message = localizationUtils.getLocalizedMessage(MessageKeys.COMMENT_REJECT_SUCCESS);
        ApiResponse<CommentResponse> response = ApiResponse.success(message, comment);
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteComment(@PathVariable Long id) {
        ...
        String message = localizationUtils.getLocalizedMessage(MessageKeys.COMMENT_DELETE_SUCCESS);
