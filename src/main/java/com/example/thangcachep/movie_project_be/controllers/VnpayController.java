...
public class VnpayController {
    ...
    public ResponseEntity<ApiResponse<String>> createPayment(@RequestBody VnpayRequest paymentRequest) {
        ...
        String message = localizationUtils.getLocalizedMessage(MessageKeys.PAYMENT_VNPAY_CREATE_SUCCESS);
        ApiResponse<String> response = ApiResponse.success(message, paymentUrl);
    ...
    public ResponseEntity<ApiResponse<VnpayPaymentResponse>> createPaymentWithQR(@RequestBody VnpayRequest paymentRequest) {
        ...
        String message = localizationUtils.getLocalizedMessage(MessageKeys.PAYMENT_VNPAY_CREATE_SUCCESS);
        ApiResponse<VnpayPaymentResponse> response = ApiResponse.success(message, paymentResponse);
        return ResponseEntity.ok(response);
    }
